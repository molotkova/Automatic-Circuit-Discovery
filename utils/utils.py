    ...
    for run in filtered_runs:
        ...
        if edges_artifact is None:
            ...
            try:
                ...
                with latest_file.download(root_cache_dir / run.id, replace=False, exist_ok=True) as f:
                    d = json.load(f)
                ...
                try:
                    with run.file("output.log").download(root=root_cache_dir / run.id, replace=False, exist_ok=True) as f:
                        log_text = f.read()
